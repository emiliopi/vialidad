      ...
      <div className="max-w-7xl mx-auto space-y-8 animate-in fade-in duration-300">
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            ...
            {/* Columna de Ajustes (Izquierda, 4/12 de ancho) */}
            <div className="lg:col-span-4 space-y-6">
              
              {/* 1. Precio de Vialidad */}
              <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-6 rounded-2xl shadow-sm">
                <h3 className="text-sm font-bold text-slate-900 dark:text-slate-100 border-b border-slate-100 dark:border-slate-800 pb-2 mb-4">
                  Precio de Vialidad
                </h3>
                <form onSubmit={handleSavePrecio} className="flex flex-col sm:flex-row gap-3 items-end">
                  ...
                  <Button
                    type="submit"
                    variant="primary"
                    className="shadow-md h-[42px] px-6 shrink-0"
              ...
              <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-6 rounded-2xl shadow-sm space-y-6">
                ...
                <div className="space-y-6">
                  ...
                  <div className="border border-slate-100 dark:border-slate-800 rounded-xl p-4 bg-slate-50/50 dark:bg-slate-950/20">
                    <span className="text-xs font-bold text-slate-800 dark:text-slate-200 uppercase tracking-wider block mb-3 text-center">
                      Alcalde o Delegado
                    </span>
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <label className="cursor-pointer block">
                        <input
                          ...
                          className="hidden"
                        />
                        <div className="w-full h-28 border border-dashed border-slate-200 dark:border-slate-700 hover:border-sky-500 dark:hover:border-sky-400 bg-white dark:bg-slate-900 rounded-xl flex items-center justify-center overflow-hidden relative group transition-colors">
                          {firmaAlcaldeUrl ? (
                            <img
                            ...
                            <div className="text-center text-slate-400 p-2">
                              ...
                              <span className="text-[10px]">Cargar firma</span>
                            </div>
                          )}
                          {uploadingAlcalde && (
                      ...
                      <form onSubmit={handleSaveLayout} className="flex flex-col justify-between space-y-2">
                        ...
                        >
                          {savingLayout ? 'Guardando...' : 'Aplicar Medidas'}
                        </Button>
                      </form>
                    </div>
                  </div>
                  ...
                  <div className="border border-slate-100 dark:border-slate-800 rounded-xl p-4 bg-slate-50/50 dark:bg-slate-950/20">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 items-center">
                        ...
                        <div className="w-full h-28 border border-dashed border-slate-200 dark:border-slate-700 hover:border-sky-500 dark:hover:border-sky-400 bg-white dark:bg-slate-900 rounded-xl flex items-center justify-center overflow-hidden relative group transition-colors">
                          {logoCardUrl ? (
                            ...
                            <div className="text-center text-slate-400 p-2">
                              ...
                              <span className="text-xs">Cargar logo</span>
                            </div>
                          )}
                          {uploadingLogo && (
                            <div className="absolute inset-0 bg-white/80 dark:bg-slate-900/80 flex items-center justify-center">
                      ...
                      <div className="text-[11px] text-slate-400 italic text-center sm:text-left leading-relaxed">
                        Logo frontal oficial de la boleta de vialidad. Haz clic en el recuadro para subir un nuevo archivo.
                      </div>
                    </div>
                  </div>
            ...
            {/* Columna de Vista Previa (Derecha, 8/12 de ancho, sticky) */}
            <div className="lg:col-span-8 lg:sticky lg:top-6 space-y-6">
              <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-6 rounded-2xl shadow-sm space-y-4">
                <div className="border-b border-slate-100 dark:border-slate-800 pb-2">
                  ...
                  <p className="text-slate-500 dark:text-slate-400 text-xs mt-1">
                    Visualización reactiva oficial. Cualquier cambio guardado en el precio, firmas o medidas se reflejará aquí automáticamente.
                  </p>
                </div>
